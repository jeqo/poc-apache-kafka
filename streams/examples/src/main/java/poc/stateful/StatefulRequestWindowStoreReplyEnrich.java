...
public class StatefulRequestWindowStoreReplyEnrich {
  ...
  public StatefulRequestWindowStoreReplyEnrich(String requestTopic, String requestBackendTopic,
      String responseBackendTopic, String responseTopic) {
  ...
  public Topology topology() {
    ...
    b.stream(requestTopic, Consumed.with(keySerde, valueSerde))
    ...
    b.stream(responseBackendTopic, Consumed.with(keySerde, Serdes.String()))
