...
public class MetricsPrinter {
  ...
  private void runOnce() {
    ...
    final List<org.apache.kafka.common.MetricName> selected = metricNames
      .stream()
      .filter(metricName -> metricNamesByGroup.containsKey(metricName.group()))
      .filter(metricName -> metricNamesByGroup.get(metricName.group()).contains(metricName.name()))
