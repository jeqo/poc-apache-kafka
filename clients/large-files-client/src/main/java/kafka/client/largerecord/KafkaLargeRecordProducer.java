...
public class KafkaLargeRecordProducer<K, V> implements Producer<K, V> {
    ...
    public KafkaLargeRecordProducer(Producer<byte[], Bytes> producer,
    ...
    public Future<RecordMetadata> send(ProducerRecord<K, V> record, Callback callback) {
        ...
        while (buffer.hasRemaining()) {
            ProducerRecord<byte[], Bytes> bytesRecord = new ProducerRecord<>(record.topic(), serializedKey, Bytes.wrap(serialized));
